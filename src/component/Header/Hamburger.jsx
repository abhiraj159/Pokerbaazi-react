            ...
            <Offcanvas placement="top" show={show} onHide={handleClose}>
                ...
                <Offcanvas.Body>
                    <ul className="navbar-nav">
                        <li className="dropdown position-static howToPLayNav" onClick={handleClose}>
                            <Link className="nav-item" to="/" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                How To Play
                            </Link>
                        </li>
                        <li className="dropdown position-static promotionsNav" onClick={handleClose}>
                        ...
                        <li className="dropdown position-static exploreNav" onClick={handleClose}>
                        ...
                        <li className="dropdown position-static downloadNav" onClick={handleClose}>
